...
<template>
    <div class="rounded-full select-none shadow shadow-black relative overflow-clip">
        ...
        <div v-if="settings.editable" class="absolute size-full flex flex-col justify-between opacity-0 hover:opacity-100 transition-opacity">
            <input-file accept="image/*" format="base64" @on-upload="setProfilePicture" class="flex justify-center items-center from-success/50 to-transparent bg-gradient-to-b basis-1/4 hover:basis-1/2 transition-all from-40%">
